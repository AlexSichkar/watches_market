...
module Authentication
  ...
  def default
    if user_signed_in?
      ...
      destroy_user_session_path #exit
      edit_user_registration_path #edit user
      new_user_session_path #enter
      new_user_registration_path #registration
      unless current_user.nil? # if curr user not null
    end
  end
